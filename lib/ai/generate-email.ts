...
import { z } from 'zod';
import { COMPANY_EMAIL_SYSTEM_PROMPT, generateCompanyEmailUserPrompt } from '@/lib/constants/prompts';
...
export async function generateCompanyEmailTemplate(
    ...
    try {
        ...
        console.log('🤖 Calling Gemini 3 Flash via Vertex AI with Google Search grounding...');
        console.log('');
