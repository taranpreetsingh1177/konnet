              ...
              <div className="grid gap-3">
                <div className="grid grid-cols-2 gap-4 items-center">
                  ...
                  <Select
                    ...
                    onValueChange={(val) =>
                      setFieldMapping((prev) => ({ ...prev, email: val || "" }))
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-4 items-center">
                  ...
                  <Select
                    ...
                    onValueChange={(val) =>
                      setFieldMapping((prev) => ({ ...prev, name: val || "" }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select column" />
                ...
                <div className="grid grid-cols-2 gap-4 items-center">
                  ...
                  <Select
                    ...
                    onValueChange={(val) =>
                      setFieldMapping((prev) => ({ ...prev, role: val || "" }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select column" />
        ...
        {step === "loading" && (
          <div className="py-12 text-center">
            ...
            <p className="text-gray-600">
              Importing leads and creating companies...
            </p>
          </div>
        )}
          ...
          <div className="py-12 text-center">
            ...
            {companiesCreated > 0 && (
              <p className="text-sm text-gray-500 mb-6">
                {companiesCreated}{" "}
                {companiesCreated === 1 ? "company" : "companies"} created and
